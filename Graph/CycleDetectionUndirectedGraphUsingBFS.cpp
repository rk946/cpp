...
int main()
{
	...
	bool res = g.isCycle();
	if(res)
		cout << "DFS : Cycle present"<<endl;
	else
		cout << "DFS  : cycle not present"<<endl;
	bool res1 = g.cycleDetectBFS(0);
	if(res1)
		cout << "BFS : cycle present" << endl;
	else
		cout << "BFS :  cycle not present"<<endl;
