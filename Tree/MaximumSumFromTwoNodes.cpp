...
int maxSum(node *root)
{
	...
	int case3 = right+root->data;
	int case4 = root->data+left+right;
	globlaMax = max(case1,max(case2,max(case3,case4)));
	return max(left,max(right,0))+root->data;

}
int main()
{
	int in[]={3,2,8,4,1,-25,7,5};
	int pre[] = {1,2,3,4,8,5,-25,7};
